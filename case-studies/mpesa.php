...
<body>
    ...
    <div class="container">
        ...
        <div class="why-this-solution">
            <h1>Why Smartwatch App?</h1>
            <p>Evolved from being just a mere device showing time, to finding space in fashion;
                 Smartwaches Can be a great tool to aid in cashless transactions. 
                 The chances of losing them is bare minimum.
            </p>
        </div>
    </div>
